			...
			<div class="mx-auto w-full max-w-screen-xl px-8 py-6 lg:py-8">
				<div class="md:flex md:justify-between">
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						...
						<div className="">
							<h2 class="mb-4 text-sm font-semibold uppercase text-white">Follow Me</h2>
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/alfinoraditya_/" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://alfinoraditya.my.id" class="hover:underline">
										Website
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas 8C | Di Kelola Oleh Siswa SMPN19 BOGOR
						</p>
					</div>
				</div>
			</div>
